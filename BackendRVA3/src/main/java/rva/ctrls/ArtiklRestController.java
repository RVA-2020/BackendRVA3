...
public class ArtiklRestController {
	...
	@ApiOperation(value = "Vraća artikl iz baze podataka čiji je ID prosleđen kao path varijabla")
	public Artikl getArtikl(@PathVariable("id") Integer id) {
		return this.artiklRepository.getOne(id);
	}
	
	@GetMapping("artiklNaziv/{naziv}")
	@ApiOperation(value = "Vraća kolekciju artikala koji u nazivu sadrže string prosleđen kao path varijabla")
	...
	@ApiOperation(value = "Briše artikl iz baze podataka čiji je ID prosleđen kao path varijabla")
